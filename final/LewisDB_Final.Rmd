...
##4.2 Data Structure
In order to process and manipulate the data within the project, we must get a firm grasp for what each fields data type is in **R**. This is reflected by using the 
```{r, echo=FALSE}
str(cleanCSV)
```
